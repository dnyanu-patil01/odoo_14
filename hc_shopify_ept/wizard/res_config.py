...
class ShopifyInstanceConfig(models.TransientModel):
    ...
    def action_shopify_open_shopify_instance_wizard(self):
        ...
        action = self.env["ir.actions.actions"]._for_xml_id("hc_shopify_ept.res_config_action_shopify_instance")
...
class ResConfigSettings(models.TransientModel):
    ...
    def action_shopify_open_basic_configuration_wizard(self):
        ...
        """
        try:
            view_id = self.env.ref('hc_shopify_ept.shopify_basic_configurations_onboarding_wizard_view')
        except:
            return True
    ...
    def action_shopify_open_financial_status_configuration_wizard(self):
        ...
        """
        try:
            view_id = self.env.ref('hc_shopify_ept.shopify_financial_status_onboarding_wizard_view')
        except:
            return True
        return self.shopify_res_config_view_action(view_id)
    ...
    def shopify_res_config_view_action(self, view_id):
        ...
        action = self.env["ir.actions.actions"]._for_xml_id(
            "hc_shopify_ept.action_shopify_instance_config")
