    ...
    def shopify_execute(self):
        ...
        if self.shopify_operation == "sync_product":
            ...
            if product_queue_ids:
                ...
                action_name = "hc_shopify_ept.action_shopify_product_data_queue"
                form_view_name = "hc_shopify_ept.product_synced_data_form_view_ept"
            ...
            if customer_queues:
                ...
                action_name = "hc_shopify_ept.action_shopify_synced_customer_data"
                form_view_name = "hc_shopify_ept.shopify_synced_customer_data_form_view_ept"
            ...
            if order_queues:
                ...
                action_name = "hc_shopify_ept.action_shopify_order_data_queue_ept"
                form_view_name = "hc_shopify_ept.view_shopify_order_data_queue_ept_form"
