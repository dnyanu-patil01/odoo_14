...
class ShopifyInstanceEpt(models.Model):
    ...
    def _default_discount_product(self):
        ...
        """
        discount_product = self.env.ref('hc_shopify_ept.shopify_discount_product') or False
    ...
    def _default_shipping_product(self):
        ...
        """
        shipping_product = self.env.ref('hc_shopify_ept.shopify_shipping_product') or False
    ...
    def change_auto_cron_status(self, instance):
        ...
        try:
            order_status_cron_exist = self.env.ref(
                'hc_shopify_ept.ir_cron_shopify_auto_update_order_status_instance_%d' % (
                    instance.id))
        except:
    ...
    def cron_configuration_action(self):
        ...
        """
        action = self.env.ref('hc_shopify_ept.action_wizard_shopify_cron_configuration_ept').read()[0]
    ...
    def open_reset_credentials_wizard(self):
        ...
        @author: Maulik Barad on Date 01-Oct-2020.
        """
        view_id = self.env.ref('hc_shopify_ept.view_reset_credentials_form').id
        action = self.env.ref('hc_shopify_ept.res_config_action_shopify_instance').read()[0]
