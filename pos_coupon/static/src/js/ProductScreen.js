            ...
            _setValue(val) {
                ...
                if (selectedLine.is_program_reward && val === 'remove') {
                    if (selectedLine.coupon_id) {
                        ...
                        // this.showPopup(`Coupon (${coupon_code}) has been deactivated.`);
                        // this.showPopup('ErrorPopup', {
                        //     title: (`(${coupon_code}) has been deactivated.`),
                        //     body: (`(${coupon_code}) has been deactivated.`),
                        // });
                        ...
                        // );
                        // this.showPopup('ErrorPopup', {
                        //     title: ('Program has been deactivated'),
                        //     body: (`'${
                        //         this.env.pos.coupon_programs_by_id[selectedLine.program_id].name
                        //     }' program has been deactivated.`),
                        // });
